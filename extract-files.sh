...
#Audio
adb pull system/lib/libaudio.so ../../../vendor/zte/$DEVICE/proprietary/libaudio.so
#Wifi
adb pull /system/lib/dhd.ko ../../../vendor/zte/$DEVICE/proprietary/dhd.ko
...
PRODUCT_COPY_FILES += \\
    vendor/zte/__DEVICE__/proprietary/dhd.ko:system/lib/dhd.ko \\
    ...
    vendor/zte/__DEVICE__/proprietary/libaudio.so:system/lib/libaudio.so \\
